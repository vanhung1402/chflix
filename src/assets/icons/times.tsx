...
export const TimesIcon = ({ color, width, height, className }: IconType) => (
  <svg className={className} width={width ?? ICON_SIZE_DEFAUL} height={height ?? ICON_SIZE_DEFAUL} fill={color || ICON_COLOR_DEFAULT} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
